...
const TarotReadingSlides = ({ interpretation }) => {
  ...
  return (
    <div
      className={cn(
        "relative mx-auto flex h-screen max-w-2xl flex-col justify-between p-4 text-center font-sans md:max-w-xl md:pb-16 md:pt-16"
      )}
    >
          ...
          <div className="relative flex max-h-[33vh] justify-center md:max-h-96">
            <Image
              ...
              className={cn(
                ...
                interpretation[currentSlide]?.orientation === "reversed" && "rotate-180"
              )}
            />
          </div>
        )}
