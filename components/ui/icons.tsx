...
function EmojiNice({ size = 34, color = "#000", ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
function EmojiMeh({ size = 34, color = "#000", ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      {...props}
    >
      <circle cx="128" cy="128" r="96" fill="none" stroke="currentColor" strokeMiterlimit="10" strokeWidth="12" />
      <line
        x1="88"
        y1="160"
        x2="168"
...
function EmojiSad({ size = 34, color = "#000", ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
